                  ...
                  children: [
                    {
                      ...
                      class: "inputDialog",
                      placeholder: "RS.InputDialog.Params.localText",
                    },
                  ],
                },
              ],
...
const divInnerHTML = `
  ...
  <div class="inputDialogContainer">
    ...
    <div class="buttonRow">
      <input class="defaultButton" id="inputDialog-OkBtn" type="button" value="${RS.InputDialog.Params.okButtonName}">
      <input class="defaultButton" id="inputDialog-CancelBtn" type="button" value="${RS.InputDialog.Params.cancelButtonName}">
    </div>
  </div>
`;
    ...
    onResize() {
      ...
      if (field && textBox) {
        ...
        if (RS.InputDialog.Params.isCenterAlignment) {
          const px =
            Graphics.width / 2 - RS.InputDialog.Params.textBoxWidth / 2;
          const py =
            Graphics.height / 2 - RS.InputDialog.Params.textBoxHeight / 2;
